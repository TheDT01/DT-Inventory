...
RegisterNUICallback('showBlur', function()
    Wait(50)
    TriggerEvent("dt-inventory:client:showBlur")
end) 
RegisterNetEvent("dt-inventory:client:showBlur", function()
    Wait(50)
...
RegisterNetEvent("dt-inventory:client:closeinv", function()
    closeInventory()
end)
...
RegisterNetEvent('dt-inventory:client:giveAnim', function()
