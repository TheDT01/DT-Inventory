...
function OnDropUpdate(dropId, dropData)
    ...
    TriggerClientEvent('dt-inventory:updateDropVisualData', -1, dropId, dropData.coords, itemsTable)
end
...
AddEventHandler("playerJoining", function(source)
    ...
    TriggerClientEvent('dt-inventory:setDropVisualData', Source, dataToSend)
end)