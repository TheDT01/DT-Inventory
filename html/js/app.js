...
function showBlur() {
  $.post("https://dt-inventory/showBlur");
}
...
$(document).on("contextmenu", ".item-slot", function (e) {
  ...
  if ($(this).data("item") != null) {
    ...
    $.post("https://dt-inventory/PlayDropSound", JSON.stringify({}));
...
//     localStorage.setItem('dt-inventory-color', color);
// }

// const savedColor = localStorage.getItem('dt-inventory-color');
...
function FormatAttachmentInfo(data) {
  $.post(
    "https://dt-inventory/GetWeaponData",
    JSON.stringify({
      weapon: data.name,
...
function handleAttachmentDrag() {
  ...
  $(".weapon-attachments-remove").droppable({
    ...
    drop: function (event, ui) {
      $.post(
        "https://dt-inventory/RemoveAttachment",
        JSON.stringify({
...
$(document).on("click", ".CombineItem", function (e) {
  ...
  if (combineslotData.toData.combinable.anim != null) {
    $.post(
      "https://dt-inventory/combineWithAnim",
      JSON.stringify({
    ...
    $.post(
      "https://dt-inventory/combineItem",
      JSON.stringify({
...
function optionSwitch(
  ...
  $.post(
    "https://dt-inventory/SetInventoryData",
    JSON.stringify({
    ...
    if (
      ...
      if (fromData.amount == $toAmount) {
        ...
        if (
          ...
          $.post(
            "https://dt-inventory/getCombineItem",
...
function InventoryError($elinv, $elslot) {
  ...
  $.post("https://dt-inventory/PlayDropFail", JSON.stringify({}));
}
...
(() => {
  ...
  Inventory.Close = function () {
    ...
    $.post("https://dt-inventory/CloseInventory", JSON.stringify({}));
